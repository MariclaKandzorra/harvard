...
class AttachmentAdd(DetailView):
	model= Attachment
...
#EDIT EACH OF THEM	
class TaskListEdit(DetailView):
	model= List
	template_name= 'todo/editlist.html'
	fields= '__all__'
	
	def get_absolute_url(self):
		return reverse('todo/editlist.html')
	
class TaskEdit(DetailView):
	model= Task
	template_name= 'todo/edittask.html'
	fields= '__all__'
	
class AttachmentEdit(DetailView):
	model= Attachment
